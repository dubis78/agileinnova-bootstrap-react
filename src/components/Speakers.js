        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-md-6 col-lg-4 mb-4">
                    <div className="card">
                        <img src={speaker1} className="card-img-top" alt="Foto de Catalina"/>
                ...
                <div className="col-md-6 col-lg-4 mb-4">
                    <div className="card">
                        <img src={speaker2} className="card-img-top" alt="Foto de Catalina"/>
                        <div className="card-body">
                            <div className="badges mb-2">
                ...
                <div className="col-md-6 col-lg-4 mb-4">
                    <div className="card">
                        <img src={speaker3} className="card-img-top" alt="Foto de Catalina"/>
                        <div className="card-body">
                            <div className="badges mb-2">
